...
7. Требования из раздела «ОБЯЗАТЕЛЬНО УЧЕСТЬ» — не пожелания, а условия приёмки. Нарушивший их кандидат будет отбракован целиком.
8. Язык — только русский. Ни одного иероглифа: slogan и cta печатаются на макете как есть, кандидат с иероглифом отклоняется схемой.
