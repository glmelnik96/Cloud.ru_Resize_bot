...
class Settings(BaseSettings):
    ...
    # --- usage log ---
    # The unified gateway push (POST /internal/usage) was retired 2026-08-02 —
    # the admin panel renders a per-tool block instead of one pooled counter, so
    # metrics stay in the local usage_events table and the gateway reads
    # data/app3.db read-only.
    # Technical/smoke accounts excluded from usage entirely, matching App1.
